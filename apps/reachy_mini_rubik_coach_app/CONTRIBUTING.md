...
1. Fork and clone the repo:
   ```bash
   git clone https://github.com/pollen-robotics/reachy_mini_rubik_coach_app
   cd reachy_mini_rubik_coach_app
   ```
...
- Every push to the `main` branch is automatically synchronized to [pollen-robotics/reachy_mini_rubik_coach_app](https://huggingface.co/spaces/pollen-robotics/reachy_mini_rubik_coach_app)
