...
# Dedicated app by default, but let the desktop host unlock personalities.
LOCKED_PROFILE: str | None = None if _env_flag("REACHY_MINI_UNLOCKED", default=False) else "rubiks_cube_coach"
...
class Config:
    """Configuration class for the Rubik coach app."""
