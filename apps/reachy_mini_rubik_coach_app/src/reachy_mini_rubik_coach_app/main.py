"""Entrypoint for the Reachy Mini Rubik coach app."""
...
from reachy_mini_rubik_coach_app.utils import (
    parse_args,
    setup_logger,
    handle_vision_stuff,
...
def run(
    ...
    """Run the Reachy Mini Rubik coach app."""
    # Delay imports so the dashboard/app shell can stay responsive until the coach starts.
    from reachy_mini_rubik_coach_app.moves import MovementManager
    from reachy_mini_rubik_coach_app.console import LocalStream
    from reachy_mini_rubik_coach_app.openai_realtime import OpenaiRealtimeHandler
    from reachy_mini_rubik_coach_app.tools.core_tools import ToolDependencies
    from reachy_mini_rubik_coach_app.audio.head_wobbler import HeadWobbler

    logger = setup_logger(args.debug)
    logger.info("Starting Reachy Mini Rubik Coach App")
    ...
    if args.gradio:
        ...
        from reachy_mini_rubik_coach_app.gradio_personality import PersonalityUI
        ...
        stream = Stream(
            ...
            ui_args={"title": "Reachy Mini Rubik Coach"},
        )
...
class ReachyMiniRubikCoachApp(ReachyMiniApp):  # type: ignore[misc]
    """Reachy Mini Apps entry point for the Rubik coach app."""
