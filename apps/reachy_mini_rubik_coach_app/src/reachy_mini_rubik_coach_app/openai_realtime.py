...
from reachy_mini_rubik_coach_app.config import config
from reachy_mini_rubik_coach_app.prompts import get_session_voice, get_session_instructions
from reachy_mini_rubik_coach_app.tools.core_tools import (
    ToolDependencies,
    get_tool_specs,
)
from reachy_mini_rubik_coach_app.tools.background_tool_manager import (
    ToolCallRoutine,
    ToolNotification,
...
class OpenaiRealtimeHandler(AsyncStreamHandler):
    ...
    async def apply_personality(self, profile: str | None) -> str:
        ...
        try:
            ...
            from reachy_mini_rubik_coach_app.config import config as _config
